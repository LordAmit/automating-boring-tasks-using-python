...
class Image_Note(QtGui.QMainWindow, gui_window.Ui_MainWindow):
    ...
    def sensitivity_slider(self):
        ...
        self.thumbnail_address_converted = file_handler.filepath_modified_prefix(self.thumbnail_address)
        convert_util.convert_sample(self.thumbnail_address, self.thumbnail_address_converted, value)
    ...
    def browse_file(self):
        ...
        self.thumbnail_address: str = file_handler.filepath_modified_prefix(self.file_address, "thumbnail_")
        self.modified_image_address: str = file_handler.filepath_modified_prefix(self.file_address)
