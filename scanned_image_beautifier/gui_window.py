...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.button_pdf_save = QtGui.QPushButton(self.centralwidget)
        self.button_pdf_save.setObjectName(_fromUtf8("button_pdf_save"))
        ...
        self.button_browse_pdf = QtGui.QPushButton(self.centralwidget)
        self.button_browse_pdf.setObjectName(_fromUtf8("button_browse_pdf"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_pdf_save.setText(_translate("MainWindow", "Save as PDF", None))
        self.button_delete.setText(_translate("MainWindow", "Delete", None))
        self.button_reset.setText(_translate("MainWindow", "Reset", None))
        self.button_browse_pdf.setText(_translate("MainWindow", "Browse PDF", None))
